package com.armando.pos_armando.data.local

import android.content.Context
import android.content.SharedPreferences
import com.armando.pos_armando.data.model.ActionState
import com.armando.pos_armando.data.model.AuthUser
import com.armando.pos_armando.util.getObject
import com.armando.pos_armando.util.putObject
...
class AuthPref(val context: Context) {
    ...
    suspend fun login (email:String, password:String):ActionState<AuthUser>{
        val user = authUser
        return if(user==null){
            ActionState(message = "Email Belum Terdaftar", isSuccess = false)
    ...
    fun register(user: AuthUser):ActionState<AuthUser>{
    ...
    suspend fun signout():ActionState<Boolean>{
        isLogin = false
        return ActionState(true,message = "Anda Berhasil Sign Out")
    }
